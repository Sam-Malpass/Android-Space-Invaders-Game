...
public class PowerInvader extends Invader {
    public PowerInvader(Context context, int row, int column, int screenX, int screenY) {
        rect = new RectF();
        length = screenX / 20;
        height = screenY / 20;
        visible = true;
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.power1);
        bitmap2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.power2);
